                                    ...
                                    <div class="detail-selected room-selected">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 cart-item-info">
                                                ...
                                                <div class="info info-child5" style="display:none"><?php echo $cart_item['customData']['child_under5']; ?></div>
                                                <div class="info info-child10" style="display:none"><?php echo $cart_item['customData']['child_under10']; ?></div>
                                                <div class="info info-child11" style="display:none"><?php echo $cart_item['customData']['child_over10']; ?></div>
