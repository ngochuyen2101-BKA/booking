...
<div class="woocommerce-order container">
	<div class="woocommerce-thank-you-page">
		...
		<div class="content-thank-you">Cảm ơn bạn đã đặt phòng tai Bamboo Sapa Hotel vui lòng đợi trong 30p, chúng tôi sẽ kiểm tra va xác nhận thông tin đặt phòng va thanh toán của bạn qua sms va email. Lưu ý: Bạn hãy lưu lại mã đặt phòng để check-in nhận phòng</div>
		<form method="post" action="/wp-content/generate.php">
			...
			<button class="export-bill" type="submit"> Xác nhận và hoàn thành đặt phòng </button>
		</form>
	</div>
</div>