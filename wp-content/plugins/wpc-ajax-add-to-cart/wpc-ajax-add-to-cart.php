...
! defined( 'WOOAA_VERSION' ) && define( 'WOOAA_VERSION', '1.5.4' );
...
if ( ! class_exists( 'WPCleverWooaa' ) ) {
	class WPCleverWooaa {
		...
		function __construct() {
			...
			add_action( 'wp_ajax_wooaa_add_to_cart_variable', array( $this, 'add_to_cart_variable' ) );
			add_action( 'wp_ajax_nopriv_wooaa_add_to_cart_variable', array( $this, 'add_to_cart_variable' ) );
		...
		function enqueue_scripts() {
			...
			wp_localize_script( 'wooaa-frontend', 'wooaa_vars', array(
					...
					'product_types' => implode( ',', (array) get_option( 'wooaa_product_types', array( 'all' ) ) )
				)
			);
		}
		...
		function register_settings() {
			// settings
			register_setting( 'wooaa_settings', 'wooaa_product_types' );
		}
                        ...
                        <form method="post" action="options.php">
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
										<?php
										$search_types  = get_option( 'wooaa_product_types', array( 'all' ) );
										$product_types = wc_get_product_types();
										$product_types = array_merge( array( 'all' => esc_html__( 'All', 'wpc-ajax-add-to-cart' ) ), $product_types );

										echo '<select name="wooaa_product_types[]" multiple style="width: 200px; height: 150px;">';
